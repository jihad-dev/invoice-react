...
//   //       });
//   //   }, []);
//   //   console.log(data.length, "All data get ");
...
const InvoiceForm = () => {
  ...
  // Handle adding new item in invoice
  const handleAddItem = () => {
    setItems([
      ...items,
      { title: "", description: "", rate: 0, qty: 1, tax: true },
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded shadow">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="border flex items-center justify-center">
              ...
              {/* <img className="w-25 border border-dashed" src={file} alt="Logo" /> */}
            </div>
          </div>
            ...
            {items.map((item, index) => (
              <div key={index} className="grid grid-cols-5 gap-4 mb-4">
                ...
                {/* <input
                  ...
                  checked={item.tax}
                  onChange={(e) =>
                    handleInputChange(index, "tax", e.target.checked)
                  }
                /> */}
              </div>
            ))}
          ...
          <div className="mt-8">
            ...
            <div className="flex justify-between">
              <p className="font-medium">Tax (15%):</p>
              <p>{tax}</p>
            </div>
            <div className="flex justify-between">
